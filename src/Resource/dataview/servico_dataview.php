                    ...
                    <tr>
                        ...
                        <td>
                            <div class="hidden-sm hidden-xs action-buttons">
                                <a class="green" href="#servico" role="button" data-toggle="modal" onclick="AlterarServicoModal('<?= $servico[$i]['id'] ?>', '<?= $servico[$i]['ServNome'] ?>')">
                                    <i title="Alterar Serviço" class="ace-icon fa fa-pencil bigger-130"></i>
                                </a>
                                <a class="red" href="#modalExcluir" data-toggle="modal" onclick="ExcluirModal('<?= $servico[$i]['id'] ?>', '<?= $servico[$i]['ServNome'] ?>')">
                            ...
                            <div class="hidden-md hidden-lg">
                                <div class="inline pos-rel">
                                    ...
                                    <ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
                                        <li>
                                            <a href="#servico" onclick="AlterarServicoModal('<?= $servico[$i]['id'] ?>', '<?= $servico[$i]['ServNome'] ?>')" data-toggle="modal" class="tooltip-success" data-rel="tooltip" title="Edit">
                                                <span class="green">
                                        ...
                                        <li>
                                            <a href="#modalExcluir" role="button" data-toggle="modal" class="tooltip-error" title="Delete" onclick="ExcluirModal('<?= $servico[$i]['id'] ?>', '<?= $servico[$i]['ServNome'] ?>')">
                                                <span class="red">
